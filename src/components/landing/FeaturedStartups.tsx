  ...
  return (
    <section id="startups" className="py-24 md:py-32 relative">
      ...
      <div className="container relative mx-auto px-4 max-w-5xl">
        ...
        >
          <span className="text-sm font-medium text-primary mb-3 block tracking-wider">SHOWCASE</span>
            ...
            >
              ...
              <div className="relative flex items-start gap-4">
                <motion.div
                  ...
                  className="w-12 h-12 rounded-xl bg-accent/10 flex items-center justify-center shrink-0 group-hover:bg-accent/20 transition-colors duration-300"
                >
