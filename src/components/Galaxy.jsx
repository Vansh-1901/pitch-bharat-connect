...
export default function Galaxy(props) {
  ...
  useEffect(() => {
    ...
    // give the canvas a visible background so stars are always visible
    ...
    // ensure canvas behaves like a background layer
    ...
    function update(t) {
      ...
      // slowly move star layers for visible animation
      program.uniforms.uStarSpeed.value = time * 0.05;
  ...
  return <div ref={ref} className="galaxy-container" {...props} />;
}
